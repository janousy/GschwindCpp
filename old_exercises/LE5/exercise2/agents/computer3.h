...
#ifndef EXERCISE2_COMPUTER3_H
#define EXERCISE2_COMPUTER3_H

#include <iostream>
#include <string>
#include <stdlib.h>

//by Dominik Frauchiger
...
struct computer3 {
    ...
    computer3() : name("Bot"), me(0), last(0) {
        //std::cout << "Bot created" << std::endl;
    };

    computer3(std::string name) : name(name), me(0), last(0) {};
